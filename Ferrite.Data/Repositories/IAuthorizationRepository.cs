...
public interface IAuthorizationRepository
{
    ...
    public ValueTask<bool> PutAuthorizationAsync(AuthInfo info);
    ...
    public ValueTask<bool> DeleteAuthorizationAsync(long authKeyId);
    public bool PutExportedAuthorization(ExportedAuthInfo exportedInfo);
    public ValueTask<bool> PutExportedAuthorizationAsync(ExportedAuthInfo exportedInfo);
