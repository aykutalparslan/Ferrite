...
public class GroupCallImpl : GroupCall
{
    ...
    public override int Constructor => -1636664659;
    public override ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            writer.WriteTLString(_participantsNextOffset);
    ...
    private string _participantsNextOffset;
    public string ParticipantsNextOffset
    {
        get => _participantsNextOffset;
        set
        {
            serialized = false;
            _participantsNextOffset = value;
        }
    }
