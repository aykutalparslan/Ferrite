...
public class AuthorizationImpl : Authorization
{
    ...
    public override int Constructor => 872119224;
    public override ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            if (_flags[1])
            {
                writer.WriteInt32(_otherwiseReloginDays, true);
            }
            ...
            writer.Write(_user.TLBytes, false);
            serialized = true;
            return writer.ToReadOnlySequence();
        }
    }
    ...
    private int _otherwiseReloginDays;
    public int OtherwiseReloginDays
    {
        get => _otherwiseReloginDays;
        set
        {
            serialized = false;
            _flags[1] = true;
            _otherwiseReloginDays = value;
        }
    }
    ...
    public override void Parse(ref SequenceReader buff)
    {
        ...
        if (_flags[1])
        {
            _otherwiseReloginDays = buff.ReadInt32(true);
        }
