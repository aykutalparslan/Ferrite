...
public class ChannelParticipantsImpl : ChannelParticipants
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public ChannelParticipantsImpl(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public override int Constructor => -1699676497;
    ...
    private Vector<ChannelParticipant> _participants;
    public Vector<ChannelParticipant> Participants
    {
        get => _participants;
        set
        {
    ...
    public override void Parse(ref SequenceReader buff)
    {
        ...
        buff.Skip(4); _participants  =  factory . Read < Vector < ChannelParticipant > > ( ref  buff ) ; 
