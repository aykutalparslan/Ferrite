...
public class SendAsPeersImpl : SendAsPeers
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public SendAsPeersImpl(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public override int Constructor => -2091463255;
    ...
    {
        serialized = false;
        buff.Skip(4); _peers  =  factory . Read < Vector < Peer > > ( ref  buff ) ; 
