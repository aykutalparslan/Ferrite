...
public class BlockedSliceImpl : Blocked
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public BlockedSliceImpl(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public override int Constructor => -513392236;
    public override ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            writer.Write(_blocked.TLBytes, false);
    ...
    private Vector<PeerBlocked> _blocked;
    public Vector<PeerBlocked> Blocked
    {
        get => _blocked;
        set
        {
    ...
    public override void Parse(ref SequenceReader buff)
    {
        ...
        buff.Skip(4); _blocked  =  factory . Read < Vector < PeerBlocked > > ( ref  buff ) ; 
