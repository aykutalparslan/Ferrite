...
public class TopPeerCategoryPeersImpl : TopPeerCategoryPeers
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public TopPeerCategoryPeersImpl(ITLObjectFactory objectFactory)
    {
    ...
    public override ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            writer.Write(_category.TLBytes, false);
    ...
    private TopPeerCategory _category;
    ...
    private Vector<TopPeer> _peers;
    public Vector<TopPeer> Peers
    {
        get => _peers;
        set
        {
