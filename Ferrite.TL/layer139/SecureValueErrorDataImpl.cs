...
public class SecureValueErrorDataImpl : SecureValueError
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public SecureValueErrorDataImpl(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public override int Constructor => -391902247;
    public override ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            writer.WriteTLBytes(_dataHash);
            writer.WriteTLString(_field);
