...
public class InputDocumentFileLocationImpl : InputFileLocation
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public InputDocumentFileLocationImpl(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public override int Constructor => -1160743548;
    public override ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            writer.WriteTLString(_thumbSize);
            serialized = true;
            return writer.ToReadOnlySequence();
        }
    }
