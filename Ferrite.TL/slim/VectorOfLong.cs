...
public readonly unsafe struct VectorOfLong : ITLStruct<VectorOfLong>, ITLBoxed
{
    ...
    public static VectorOfLong Read(Span<byte> data, in int offset, out int bytesRead)
    {
    ...
    public static VectorOfLong Read(byte* buffer, in int length, in int offset, out int bytesRead)
    {
