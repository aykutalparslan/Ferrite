...
public readonly ref struct p_q_inner_data_temp
{
    ...
    public readonly int expires_in => MemoryMarshal.Read<int>(_buff[GetOffset(7, _buff)..]);
    ...
    public ref struct TLObjectBuilder
    {
        ...
        public p_q_inner_data_temp Build()
        {
            return new p_q_inner_data_temp(_pq, _p, _q, _nonce, _server_nonce, _new_nonce, _expires_in);
        }
    }
