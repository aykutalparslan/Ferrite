...
public class SetClientDhParams : ITLObject, ITLMethod
{
    ...
    private readonly IDistributedCache distributedStore;
    ...
    public SetClientDhParams(ITLObjectFactory objectFactory, IPersistentStore store, IDistributedCache cache)
    {
