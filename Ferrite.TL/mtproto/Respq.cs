...
public class Respq : ITLObject
{
    ...
    public ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            writer.Write(serverPublicKeyFingerprints.TLBytes, false);
            serialized = true;
            return writer.ToReadOnlySequence();
        }
    }
    ...
    private VectorOfLong serverPublicKeyFingerprints;
    public VectorOfLong ServerPublicKeyFingerprints
    {
        get => serverPublicKeyFingerprints;
        set
        {
            serialized = false;
    ...
    public void Parse(ref SequenceReader buff)
    {
        ...
        buff.Skip(4); serverPublicKeyFingerprints = factory.Read<VectorOfLong>(ref buff);
    }
