...
public class DhGenOk : ITLObject
{
    private SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private ITLObjectFactory factory;
    private bool serialized = false;
    public DhGenOk(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public int Constructor => 1003222836;
    public ReadOnlySequence<byte> TLBytes
    {
        get
        {
            ...
            writer.Write(newNonceHash1.TLBytes, false);
            serialized = true;
            return writer.ToReadOnlySequence();
        }
    }
    ...
    private Int128 newNonceHash1;
    public Int128 NewNonceHash1
    {
        get => newNonceHash1;
        set
        {
    ...
    public void Parse(ref SequenceReader buff)
    {
        ...
        newNonceHash1 = factory.Read<Int128>(ref buff);
    }
