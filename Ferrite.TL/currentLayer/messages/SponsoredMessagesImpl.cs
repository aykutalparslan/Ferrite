...
public class SponsoredMessagesImpl : SponsoredMessages
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public SponsoredMessagesImpl(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public override int Constructor => 1705297877;
    ...
    private Vector<SponsoredMessage> _messages;
    public Vector<SponsoredMessage> Messages
    {
        get => _messages;
        set
        {
    ...
    {
        serialized = false;
        buff.Skip(4); _messages  =  factory . Read < Vector < SponsoredMessage > > ( ref  buff ) ; 
