...
public class GetSearchResultsPositions : ITLObject, ITLMethod
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public GetSearchResultsPositions(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public int Constructor => 1855292323;
    ...
    public async Task<ITLObject> ExecuteAsync(TLExecutionContext ctx)
    {
        ...
        var positions = factory.Resolve<SearchResultsPositionsImpl>();
        positions.Positions = factory.Resolve<Vector<SearchResultsPosition>>();
