...
public class PrivacyRulesImpl : PrivacyRules
{
    private readonly SparseBufferWriter<byte> writer = new SparseBufferWriter<byte>(UnmanagedMemoryPool<byte>.Shared);
    private readonly ITLObjectFactory factory;
    private bool serialized = false;
    public PrivacyRulesImpl(ITLObjectFactory objectFactory)
    {
        factory = objectFactory;
    }

    public override int Constructor => 1352683077;
    ...
    private Vector<PrivacyRule> _rules;
    public Vector<PrivacyRule> Rules
    {
        get => _rules;
        set
        {
