...
";
    ...
    public static " + combinator.Identifier +
        ...
        foreach (var arg in combinator.Arguments)
        {
            ...
            {
                string typeIdent = arg.TypeTerm.Identifier;
                if (arg.TypeTerm.OptionalType != null)
                {
                    typeIdent = typeIdent + "<" + arg.TypeTerm.OptionalType.Identifier + ">";
                }
    ...
    private void Set_"+arg.Identifier+@"(ReadOnlySpan<byte> value)
    {
        ...
        fixed (byte* p = value)
        {
            ...
            {
                sb.Append(@"
    public "+ arg.TypeTerm.Identifier +" "+arg.Identifier+@" => "+ arg.TypeTerm.Identifier +@".Read(new (_buff + GetOffset("+index+@", _buff, Length), 32);");
                sb.Append(@"
    private void Set_"+arg.Identifier+@"(ReadOnlySpan<byte> value)
    {
        fixed (byte* p = value)
